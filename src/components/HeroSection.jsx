...
export function HeroSection() {
  ...
  const heroTexts = [
    "اكتشف التراث العلمي العربي والإسلامي",
    "تعرف على عباقرة العلماء العرب",
    "تعرف على الاكتشافات التي غيرت العالم",
    "رحلة عبر العصر الذهبي للعلوم",
    "المنصة الأولى في العلوم العربية والإسلامية من نوعها",
    "غرس الثقافة العلمية والهوية العربية والإسلامية في عقول الشباب"
  ];
